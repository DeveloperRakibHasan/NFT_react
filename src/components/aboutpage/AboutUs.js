            ...
            <div className='grid grid-flow-row md:grid-cols-2 sm:grid-cols-1'>
                ...
                <div>
                    ...
                    <div className='xl:ml-[200px] lg:ml-[120px] md:ml-10'>
                        <h2 className='sm:text-[44px] xm:text-[30px] text-white mb-5' data-aos="fade-up" data-aos-duration="400">About us</h2>
                        ...
                        <div className='xl:mt-12 lg:mt-6 md:mt-4 sm:mt-8 xm:mt-4 flex'>
