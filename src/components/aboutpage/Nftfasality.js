            ...
            <div className='grid grid-flow-row md:grid-cols-2 sm:grid-cols-1 gap-10'>
                ...
                <div className='flex items-center'>
                    <div>
                      ...
                      <button className='sm:px-4 xm:px-3 text-center sm:py-3 xm:py-2 rounded-xl button-bg sm:font-medium xm:font-normal text-white leading-7'>NFT Button</button>
                    </div>    
                 </div>
            </div>
        </div>
