  ...
  return (
    <div className='xl:py-[100px] lg:py-24 bg-[#111826]'>
        <div className='container'>
            <h2 className='text-white sm:mb-20 xm:mb-16 text-center md:text-[35px] sm:text-[30px] xm:text-[26px]'>Our mission is healping people <br></br> to get success</h2>
            <div className='grid grid-flow-row xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 xm:grid-cols-1 md:gap-8 sm:gap-20 xm:gap-6'>
                <div className='bg-[#232738] relative rounded-[18px] text-center p-6 xl:mb-0 md:mb-10' data-aos="zoom-in"  data-aos-duration="400">
                <img className=' absolute sm:w-[75px] xm:w-[45px] md:left-[38%] sm:left-[42%] 2xl:top-[-15%] xl:top-[-12%] md:top-[-20%] sm:top-[-26%]' src={icon} alt='' />
                  <h4 className='mb-4 xl:mt-12 lg:mt-8 md:mt-6 sm:mt-4 xm:mt-3 text-[28px] font-normal text-white'>Transperancy</h4>
                ...
                <img className=' absolute sm:w-[75px] xm:w-[45px] md:left-[38%] sm:left-[42%] 2xl:top-[-15%] xl:top-[-12%] md:top-[-20%] sm:top-[-26%]' src={icon2} alt='' />
                ...
                <img className=' absolute sm:w-[75px] xm:w-[45px] md:left-[38%] sm:left-[42%] 2xl:top-[-15%] xl:top-[-12%] md:top-[-20%] sm:top-[-26%]' src={icon3} alt='' />
                ...
                <img className=' absolute sm:w-[75px] xm:w-[45px] md:left-[38%] sm:left-[42%] 2xl:top-[-15%] xl:top-[-12%] md:top-[-20%] sm:top-[-26%]' src={icon4} alt='' />
