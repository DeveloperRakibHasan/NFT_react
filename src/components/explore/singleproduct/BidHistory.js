...
function BidHistory() {
  return (
    <div className='bg-[#232738] w-full rounded-3xl py-5 xl:px-8 lg:px-4 md:px-8'>
        <div className='flex mb-7'>
            <button className='xl:px-10 xl:py-3 lg:px-8 lg:py-3 md:px-10 md:py-3 rounded-xl button-bg font-medium text-white leading-7'>Details</button>
            <button className='xl:px-10 xl:py-3 lg:px-8 lg:py-3 md:px-10 md:py-3 ml-2 rounded-xl font-medium text-gray-400 leading-7'>Bid History</button>
            <button className='xl:px-10 xl:py-3 lg:px-8 lg:py-3 md:px-10 md:py-3 ml-2 rounded-xl font-medium text-gray-400 leading-7'>Owner</button>
        </div>
        <div className=' table-cell mb-3 w-full'>
            <div className='bg-[#111826] inline-block mb-[14px] 2xl:px-6 xl:px-4 lg:px-2 lg:py-2 md:px-4 md:py-2 xl:py-3 mr-[14px] rounded-xl'>
