      ...
      <div className='z-0 grid grid-flow-row grid-cols-3 ml-20'>
        ...
        <div className='container'>
            ...
            <div className='slider-area lg:grid-cols-2 md:grid-cols-1 2xl:pt-[180px] xl:pt-[146px] lg:pt-[100px] md:pt-[100px]'>
              ...
              <div className='lg:mt-0 lg:block md:mt-[100px] md:flex md:justify-center'>
              <img className='xl:block md:hidden sm:hidden xm:hidden absolute mt-[-180px] ml-[-120px]' src={link} alt='' />
                <AntiqCard />
              </div>
            </div>
        </div>
