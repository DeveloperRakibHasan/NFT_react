...
function Subscribe() {
  return (
    <div>
        <div className='xl:flex xm:grid xm:grid-flow-row lg:grid-cols-2 md:grid-cols-3 md:grid-flow-row sm:grid-cols-3 xm:grid-cols-2 lg:justify-center md:mt-0 sm:my-8 xm:my-8'>
