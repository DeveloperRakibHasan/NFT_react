    ...
    <div className='grid grid-flow-row lg:grid-cols-3 md:grid-cols-2 xm:grid-cols-1 gap-8'>
       <div className='lg:col-start-1 md:col-start-1 md:row-start-1 xm:row-start-auto col-span-2'>
        <div className='bg-[#232738] rounded-[30px] p-4'>
         ...
         <div className='lg:mt-12 xm:mt-0 p-8'>
            <h2 className='xl:w-6/12 lg:w-full font-bold text-white font-redhet xl:text-[35px] md:text-[32px] xm:text-[26px]'>Behing the scene of top designers</h2>
            <div className='flex justify-between items-center mt-6 mb-8'>
            <div className='flex items-center'>
              <img className='w-[50px] h-[50px] rounded-full' src={user} alt="" />
              <div className='xl:ml-5 md:ml-3 xm:ml-5 xl:text-[16px] lg:text-[14px] xm:text-[13px] text-gray-400'>
                <b>Alfonso Likens</b>
                <p>writer</p>
              </div>
            </div>
          ...
          <p className='text-gray-400 xl:text-[16px] sm:text-[14px] xm:text-[12px]'>
       ...
       <div className='lg:col-start-1 md:col-start-1 xm:row-start-auto col-span-2 mt-[30px]'>
        ...
        <div className='lg:col-start-3 md:col-start-1 xm:col-start-1 lg:row-start-1 md:row-start-3 xm:row-start-auto row-span-6 lg:col-span-1 xm:col-span-2'>
           <RecentArticles/>
           <BlogCategories/>
            <BlogConnect />
        </div>
